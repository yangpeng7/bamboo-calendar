...
const calendar = {
  ...
  overtime: [
    ...
    "2023-10-07",
    "2023-10-08",
    "2024-02-04", "2023-02-09", "2024-02-18",
    "2024-04-07",
    "2024-04-28",
    "2024-05-11",
    "2024-09-14",
  ...
  holiday: [
    ...
    "2024-02-10", "2024-02-11", "2024-02-12", "2024-02-13", "2024-02-14", "2024-02-15",
   ...
   * @param {日期}} date 
   */
  stateCouncilDate: function (date) {
    if (this.holiday.includes(date)) {
      return "休"
    } else if (this.overtime.includes(date)) {
      return "班"
    } else {
      return null
    }
